-- =============================================
-- MOM Project - Database Setup (MOM_Meet)
-- =============================================

CREATE DATABASE [MOM_Meet];
GO
...
-- Initial Seeding
INSERT INTO MOM_User (Username, Password) VALUES ('Meet', 'meet123');
GO
...
-- =============================================
-- MOM_User Stored Procedures
-- =============================================

CREATE OR ALTER PROCEDURE [dbo].[PR_MOM_User_SelectForLogin]
...
BEGIN
    ...
    DELETE FROM [dbo].[MOM_MeetingMember] WHERE MeetingID IN (SELECT MeetingID FROM [dbo].[MOM_Meetings] WHERE MeetingTypeID = @MeetingTypeID)
    DELETE FROM [dbo].[MOM_Meetings] WHERE MeetingTypeID = @MeetingTypeID
...
AS
BEGIN
    -- Handle Cascading Deletes manually to avoid FK constraint errors
    DELETE FROM [dbo].[MOM_MeetingMember] WHERE MeetingID IN (SELECT MeetingID FROM [dbo].[MOM_Meetings] WHERE DepartmentID = @DepartmentID)
    DELETE FROM [dbo].[MOM_MeetingMember] WHERE StaffID IN (SELECT StaffID FROM [dbo].[MOM_Staff] WHERE DepartmentID = @DepartmentID)
    DELETE FROM [dbo].[MOM_Meetings] WHERE DepartmentID = @DepartmentID
    DELETE FROM [dbo].[MOM_Staff] WHERE DepartmentID = @DepartmentID
...
BEGIN
    -- Handle Cascading Deletes manually
    DELETE FROM [dbo].[MOM_MeetingMember] WHERE MeetingID IN (SELECT MeetingID FROM [dbo].[MOM_Meetings] WHERE MeetingVenueID = @MeetingVenueID)
    DELETE FROM [dbo].[MOM_Meetings] WHERE MeetingVenueID = @MeetingVenueID
...
AS
BEGIN
    -- Handle Cascading Delete manually
    DELETE FROM [dbo].[MOM_MeetingMember] WHERE StaffID = @StaffID
...
BEGIN
    -- Handle Cascading Deletes manually
    DELETE FROM [dbo].[MOM_MeetingMember] WHERE MeetingID = @MeetingID
